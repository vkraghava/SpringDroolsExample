...
public class DroolsBeanFactory {
    ...
    public KieSession getKieSession(Resource dt) {
        ...
        //KieRepository kieRepository = kieServices.newReleaseId("com.example.drools", "droolsdemo", "0.0.1-SNAPSHOT");

        ReleaseId krDefaultReleaseId =kieServices.newReleaseId("com.example.drools", "droolsdemo", "0.0.1-SNAPSHOT");// kieRepository.getDefaultReleaseId();
    ...
    public String getDrlFromExcel(String excelFile) {
        ...
        String drl = null;
        drl = decisionTableProvider.loadFromResource(dt,configuration);
